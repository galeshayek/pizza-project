  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 py-4 md:pl-2">
        <ul className="flex justify-between border-b p-2 text-xl  font-semibold shadow *:w-3/12 *:text-center md:w-11/12">
          <li>Info</li>
          <li>Added at</li>
          <li>Actions</li>
        </ul>
        {recipes.map((r) => (
          <div
            ...
            key={r._id}
          >
            <Badge>{recipes.indexOf(r) + 1}</Badge>
      ...
      <div className="  flex justify-center overflow-x-auto pb-8"></div>
    </>
  );
};
